...
class BotLogicTest {
     ...
     * что код обязан гаранитировать такую последовательность задаваемых примеров</p>
     */
    @Test
    ...
    /**
     * Проверка на то, что сообщение не будет поставлено на отправку, если задать текст вместо числа в виде дилея
     */
    @Test
